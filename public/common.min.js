...
(function () {
    ...
    var switched = doc.querySelector('.switch'),
    ...
    var data = 'data-scroll',
        anchor = 'data-anchor';

    for (var i = 0, len = dots.length; i < dots; i++) {
        var dot = dots[i];
    ...
    function dotHandler(e) {
        ...
        if (dot.hasAttribute(data)) id = dot.hasAttribute(anchor) ? dot.getAttribute(anchor) : false;
