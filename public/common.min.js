...
(function () {
    ...
    for (var i = 0; i < NAVIGATOR_LENGTH; i++) {
        var link = NAVIGATOR_LINKS[i];

        link.addEventListener('click', handler, false);
    }

    for (var _i = 0; _i < DOTS_LENGTH; _i++) {
        var dot = DOTS[_i];
    ...
    function handler(e) {
        ...
        if (that.hasAttribute(DATA_NAME) && that.hasAttribute(DATA_TARGET)) {
            ...
            for (var _i2 = 0; _i2 < SECTIONS_LENGTH; _i2++) {
    ...
    function viewCurrentSection() {
        for (var _i3 = 0; _i3 < DOTS_LENGTH; _i3++) {
            var _dot = DOTS[_i3];
